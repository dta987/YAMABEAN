...
public class MyMenuModel {
	...
	public String toString() {
		return "MyMenuModel [menuEntity=" + menuEntity + ", mymenu_num="
				+ mymenu_num + ", member_id=" + member_id + ", mymenu_name="
				+ mymenu_name + ", my_optionSize=" + my_optionSize
				+ ", sub_day=" + sub_day + ", mymenu_price=" + mymenu_price
