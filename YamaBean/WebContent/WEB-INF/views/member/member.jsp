...
<body>
 ...
 <form class="form" method="POST" >
  ...
  <div class="form-group1" align="left">
            ...
            <div class="form-group1" style="width: 110px; float: left; padding-left: 10px;" align="left">
               <input type="button" id="ajax_request" class="btn btn-primary btn-block" value="중복검사" />
            </div>
               ...
               <div style="background-color: blue;">
                  <div>
                     ...
                     <div style="float: left; width: 20px;">
                        <input type="radio" name="gender" id="gender" class="form-control" value="남자" />
                     </div>
                  </div>
                  ...
                  <div>
                     ...
                     <div style="float: left; width: 20px;">
                        <input type="radio" name="gender" id="gender" class="form-control" value="여자" />
                     </div>
                  </div>
               </div>
            </div>
 ...
 <div class="form-group1" align="left">
               ...
               <div class="form-group1" style="width: 230px; float: left;" align="left">
                  <input type="text" name="phone" id="phone" class="form-control" placeholder="Ex) 01012345678" required/>
               </div>
     ...
     <div class="form-group1" align="left">
            ...
            <div class="form-group1" style=" float: left;" align="left">
               <input type="text" name="nickname" id="nickname" class="form-control" placeholder="Enter Your E-Mail" required/>
            </div>
     ...
     <div class="form-group1" align="left">
            ...
            <div class="form-group1" style=" float: left;" align="left">
               <input type="text" name="address" id="address" class="form-control" placeholder="Enter Your E-Mail" required/>
            </div>
         ...
         <!-- birth -->
            ...
            <div class="form-group1" align="left">
               ...
               <div class="form-group1" style="width: 230px; float: left;" align="left">
                  <input type="text" name="bday" id="bday" class="form-control" size="20" required/>
               </div>
         ...
         <div class="form-group1" align="left">
            ...
            <div class="form-group1" style="float: left;"   align="left">
               <input type="text" name="email" id="email" class="form-control" placeholder="Enter Your Nickname" required/>
            </div>
