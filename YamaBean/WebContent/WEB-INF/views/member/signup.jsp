...
<script language="javascript" type="text/javascript">
	...
	function checkIt() {
		...
		if (!name_write(/^[가-히a-zA-Z]{2,5}$/, name, "이름을 확인해주세요")) {
			return false;
		}
	...
	$(function() {
		$("#id")
				.change(
						function() {
							if (id_write(/^[a-zA-Z][a-zA-Z\d]{3,11}$/, document
									.getElementById("id"),
...
<body>
	<div
		style="margin-left: 100px; margin-top: 100px; padding-bottom: 100px;">
			...
			<form action="${pageContext.request.contextPath}/member/signup"
				...
				<div class="form-group">
					<label>아이디</label> <label id="mylabelid"></label><br> <input
						...
						placeholder="Enter ID"> <input type="hidden"
						name="overcheckid" id="overcheckid" value="false">
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<label>닉네임</label> <label id="mylabelnickname"></label><br> <input
						...
						placeholder="Enter NickName"> <input type="hidden"
						name="overchecknickname" id="overchecknickname" value="false">
				</div>
				<div class="form-group">
					<label>성별</label>
					<div class="radio">
						<label><input type="radio" name="gender" id="남"
							value="남자">남자</label> <label><input type="radio"
							name="gender" id="여" value="여자">여자</label>
					</div>
				</div>
				<div class="form-group">
					<label>생년월일</label>
				...
				<div class="form-group">
					...
					<div class="form-inline">
						<input class="form-control" type="text" id="first_email"
							name="first_email" placeholder="Enter mail">@ <input
							class="form-control" type="text" id="last_email"
							name="last_email"> <select class="form-control"
							id="email_select">
				...
				<div class="form-group">
					...
					<div class="form-inline">
						<input class="form-control" id="zipcode" readonly="readonly"
							size="10" name="zipcode" placeholder="Address Code"> <input
							onclick="zipCheck()" class="btn btn-success" type="button"
							value="우편번호찾기"><br> <span style="LINE-HEIGHT: 10%"><br></span>
					</div>
